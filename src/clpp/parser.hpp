...
public:
    detail::parameter& add_parameter( const std::string& short_name
    ...
    detail::parameter& add_parameter( const std::string& single_name
                              , void ( *fn )() ) {
...
private:
    ...
    detail::parameter& create_parameter( const std::string&  short_name
                                , const std::string& full_name
                                , const PtrToFun&    ptr_to_fun ) { 
        check_null_ptr( ptr_to_fun, short_name );
        check_names_validity( short_name, full_name );

        registered_parameters += detail::parameter( short_name, full_name, ptr_to_fun );
    ...
    detail::parameter& create_parameter( const std::string&  short_name
        ...
        registered_parameters += detail::parameter( short_name, full_name, ptr_to_obj, ptr_to_fun );
        return registered_parameters.back();
    }
private:
...
private:
    ...
    bool no_parameters_with_default_value() const {
        parameter_const_it it = std::find_if( registered_parameters.begin()
                                              , registered_parameters.end()
                                              , boost::mem_fn( &detail::parameter::has_default_value ) );
    ...
    bool no_necessary_parameters() const {
        parameter_const_it it = std::find_if( registered_parameters.begin()
                                              , registered_parameters.end()
                                              , boost::mem_fn( &detail::parameter::it_is_necessary ) );
        return registered_parameters.end() == it;
    }
